...
$sql = 'SELECT * FROM admin ORDER BY ad_id DESC LIMIT ' . $this_page_first_result . ', ' . $results_per_page;
...
<html lang="fr">
  <head>
    ...
    <title>Administrateurs — Administration Restaurant</title>
    ...
    <div class="admin-wrapper">
      <aside id="sidebar">
        ...
        <div class="menu">
          ...
          <a class="active" href="viewadmin.php"><i class="fa fa-user-secret"></i> Administrateurs</a>
      ...
      <div class="content">
        <div class="topbar">
          ...
          <div class="brand-title">Administrateurs</div>
          <div class="d-flex align-items-center">
            <span class="mr-3 text-muted d-none d-sm-inline">Bonjour, <?php echo htmlspecialchars($_SESSION['Name']); ?></span>
            <a class="btn btn-sm btn-outline-secondary" href="adminregister.php"><i class="fa fa-user-plus"></i> Nouvel admin</a>
                  </div>
                </div>
          ...
          <div class="card card-elevated">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a class="btn btn-sm btn-primary" href="adminregister.php"><i class="fa fa-plus"></i> Ajouter</a>
              </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php while($row = mysqli_fetch_assoc($result)) { ?>
                      <tr>
                        <td>
                          <a class="btn btn-sm btn-outline-danger" href="editAcc.php?Email=<?php echo urlencode($row['Email']); ?>" onclick="return confirm('Supprimer cet administrateur ?');" title="Supprimer"><i class="fa fa-trash"></i></a>
                            </td>
                ...
                <ul class="pagination pagination-sm mb-0">
                  <?php for ($i = 1; $i <= $number_of_pages; $i++) { ?>
                    <li class="page-item <?php echo ($i === $page) ? 'active' : ''; ?>">
                      <a class="page-link" href="viewadmin.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                  <?php } ?>
                </ul>
              </nav>
