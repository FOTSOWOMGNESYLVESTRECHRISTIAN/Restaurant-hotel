...
$sql = 'SELECT * FROM orders ORDER BY order_id DESC LIMIT ' . $this_page_first_result . ', ' . $results_per_page;
...
<html lang="fr">
  <head>
    ...
    <title>Historique des commandes — Administration Restaurant Hôtel</title>
    ...
    <div class="admin-wrapper">
      <aside id="sidebar">
        ...
        <div class="menu">
          ...
          <a class="active" href="viewhistoryOrder.php"><i class="fa fa-list-alt"></i> Commandes</a>
      ...
      <div class="content">
        <div class="topbar">
          ...
          <div class="brand-title">Historique des commandes</div>
          ...
          <div class="card card-elevated">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Commandes passées</h5>
              </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php while($row = mysqli_fetch_assoc($result)) { ?>
                      <tr>
                        <td>
                          <a class="btn btn-sm btn-outline-danger" href="editorder.php?order_id=<?php echo urlencode($row['order_id']); ?>" onclick="return confirm('Supprimer cette commande ?');" title="Supprimer"><i class="fa fa-trash"></i></a>
                            </td>
                ...
                <ul class="pagination pagination-sm mb-0">
                  <?php for ($i = 1; $i <= $number_of_pages; $i++) { ?>
                    <li class="page-item <?php echo ($i === $page) ? 'active' : ''; ?>">
                      <a class="page-link" href="viewhistoryOrder.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                  <?php } ?>
                </ul>
              </nav>
