...
// Pagination
$results_per_page = 8;
$countSql = 'SELECT COUNT(*) AS total FROM payment';
...
$sql = 'SELECT * FROM payment ORDER BY time_date DESC LIMIT ' . $this_page_first_result . ', ' . $results_per_page;
...
<html lang="fr">
  <head>
    ...
    <title>Historique des paiements — Administration Restaurant Hôtel</title>
    ...
    <div class="admin-wrapper">
      <aside id="sidebar">
        ...
        <div class="menu">
          ...
          <a class="active" href="viewPayhistory.php"><i class="fa fa-credit-card"></i> Paiements</a>
      ...
      <div class="content">
        <div class="topbar">
          ...
          <div class="brand-title">Historique des paiements</div>
          ...
          <div class="card card-elevated">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Règlements par carte</h5>
              </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php while($row = mysqli_fetch_assoc($result)) { ?>
                      <tr>
                        <td>
                          <a class="btn btn-sm btn-outline-danger" href="editPay.php?order_id=<?php echo urlencode($row['order_id']); ?>" onclick="return confirm('Supprimer ce paiement ?');" title="Supprimer"><i class="fa fa-trash"></i></a>
                            </td>
                        ...
                        <td>
                          <?php
                            ...
                            $expMonth = (int)$row['Month'];
                            $expYearShort = substr((string)$row['Year'], -2);
                            $label = '•••• ' . ($last4 ? htmlspecialchars($last4) : '0000') . ' — ' . htmlspecialchars(sprintf('%02d', $expMonth)) . '/' . htmlspecialchars($expYearShort ?: '00');
                            echo $label;
                          ?>
                        </td>
                        <td><?php echo htmlspecialchars($row['time_date']); ?></td>
                      </tr>
                    <?php } ?>
                        </tbody>
                </table>        
                ...
                <ul class="pagination pagination-sm mb-0">
                  <?php for ($i = 1; $i <= $number_of_pages; $i++) { ?>
                    <li class="page-item <?php echo ($i === $page) ? 'active' : ''; ?>">
                      <a class="page-link" href="viewPayhistory.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                  <?php } ?>
                </ul>
              </nav>
