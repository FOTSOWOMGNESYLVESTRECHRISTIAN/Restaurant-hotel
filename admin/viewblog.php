...
<html lang="fr">
  <head>
    ...
    <title>Blog — Administration Restaurant</title>
    ...
    <style>
      ...
      .message-cell { max-width: 480px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    <div class="admin-wrapper">
      <aside id="sidebar">
        ...
        <div class="menu">
          ...
          <a class="active" href="viewblog.php"><i class="fa fa-newspaper-o"></i> Blog</a>
      ...
      <div class="content">
        <div class="topbar">
          ...
          <div class="d-flex align-items-center">
            ...
            <a class="btn btn-sm btn-outline-secondary" href="view.php"><i class="fa fa-arrow-left"></i> Retour</a>
                  </div>
                </div>
          ...
          <div class="card card-elevated">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Messages du blog</h5>
              </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php while($row = mysqli_fetch_assoc($result)) { ?>
                      <tr>
                        <td>
                          <a class="btn btn-sm btn-outline-danger" href="editblog.php?id=<?php echo urlencode($row['id']); ?>" onclick="return confirm('Supprimer ce message ?');" title="Supprimer"><i class="fa fa-trash"></i></a>
                            </td>
                        <td><?php echo htmlspecialchars($row['Name']); ?></td>
                        <td><?php echo htmlspecialchars($row['Email']); ?></td>
                        <td class="message-cell" title="<?php echo htmlspecialchars($row['message']); ?>"><?php echo htmlspecialchars($row['message']); ?></td>
                ...
                <ul class="pagination pagination-sm mb-0">
                  <?php for ($i = 1; $i <= $number_of_pages; $i++) { ?>
                    <li class="page-item <?php echo ($i === $page) ? 'active' : ''; ?>">
                      <a class="page-link" href="viewblog.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                  <?php } ?>
                </ul>
              </nav>
