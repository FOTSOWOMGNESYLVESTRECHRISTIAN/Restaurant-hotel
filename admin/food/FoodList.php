...
<html lang="fr">
  <head>
    ...
    <title>Nouveau plat — Administration Restaurant Hôtel</title>
    ...
    <div class="admin-wrapper">
      ...
      <div class="content">
        <div class="topbar">
          ...
          <div class="brand-title">Nouveau plat</div>
          <div class="d-flex align-items-center">
            <a href="food.php" class="btn btn-sm btn-outline-secondary"><i class="fa fa-list"></i> Liste</a>
                                    </div>
                                </div>
              ...
              <form action="addFood.php" method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="nameFood">Nom du plat</label>
                    <input type="text" class="form-control" name="nameFood" id="nameFood" required />
                  </div>
                  <div class="form-group col-md-6">
                    <label for="cart_id">Catégorie</label>
                    <select class="form-control" id="cart_id" name="cart_id" required>
                      <?php foreach ($arr_all as $cat) { echo '<option value="'.htmlspecialchars($cat['c_id']).'">'.htmlspecialchars($cat['name']).'</option>'; } ?>
						            </select>	
                                    </div>
                                </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <img src="../../image/uknown.png" onclick="triggerClick()" id="profileDisplay" alt="Aperçu" />
                    <input name="imageFood" type="file" id="image" onchange="displayImage(this)" style="display:none" accept="image/*" />
                                    </div>
                                </div>

                <div class="text-right">
                  <button type="submit" name="insert" class="btn btn-primary"><i class="fa fa-check"></i> Ajouter</button>
                </div>
              </form>
                                    </div>
                                </div>
