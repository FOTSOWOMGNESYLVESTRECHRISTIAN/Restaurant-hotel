...
<head>
    ...
    <title>Nouvelle catégorie — Administration Restaurant Hôtel</title>
    ...
    <div class="admin-wrapper">
      ...
      <div class="content">
        <div class="topbar">
          ...
          <div class="brand-title">Nouvelle catégorie</div>
              ...
              <form action="addCategory.php" method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="category_exixts" name="category_exixts" required>
