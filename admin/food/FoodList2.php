...
$nameFood = $description = $image = '';
$price = '';
$cart_id = '';
if ($f_id !== '') {
  require('../../database/mysql.php');
  $sql = "SELECT * FROM food WHERE f_id = '" . mysqli_real_escape_string($conn, $f_id) . "'";
...
<html lang="fr">
  <head>
    ...
    <title>Modifier un plat — Administration Restaurant Hôtel</title>
    ...
    <div class="admin-wrapper">
      ...
      <div class="content">
        <div class="topbar">
          ...
          <div class="brand-title">Modifier un plat</div>
        ...
        <div class="page-content">
          <div class="card card-elevated">
            <div class="card-body">
              <form action="updateFood.php" method="POST" enctype="multipart/form-data" onsubmit="return ConfirmUpdate();">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="nameFood" id="nameFood" value="<?php echo htmlspecialchars($nameFood); ?>" required />
                  </div>
                  <div class="form-group col-md-6">
