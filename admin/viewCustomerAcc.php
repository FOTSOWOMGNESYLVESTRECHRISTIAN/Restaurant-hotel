...
$sql = 'SELECT * FROM customer ORDER BY Name ASC LIMIT ' . $this_page_first_result . ', ' . $results_per_page;
...
<html lang="fr">
  <head>
    ...
    <title>Clients — Administration Restaurant Hôtel</title>
    ...
    <div class="admin-wrapper">
      <aside id="sidebar">
        ...
        <div class="menu">
          ...
          <a class="active" href="viewCustomerAcc.php"><i class="fa fa-users"></i> Clients</a>
      ...
      <div class="content">
        <div class="topbar">
          ...
          <div class="brand-title">Clients</div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php while($row = mysqli_fetch_assoc($result)) { ?>
                      <tr>
                        <td>
                          <a class="btn btn-sm btn-outline-danger" href="editAcc.php?Email=<?php echo urlencode($row['Email']); ?>" onclick="return confirm('Supprimer ce client ?');" title="Supprimer"><i class="fa fa-trash"></i></a>
                            </td>
                ...
                <ul class="pagination pagination-sm mb-0">
                  <?php for ($i = 1; $i <= $number_of_pages; $i++) { ?>
                    <li class="page-item <?php echo ($i === $page) ? 'active' : ''; ?>">
                      <a class="page-link" href="viewCustomerAcc.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                  <?php } ?>
                </ul>
              </nav>
